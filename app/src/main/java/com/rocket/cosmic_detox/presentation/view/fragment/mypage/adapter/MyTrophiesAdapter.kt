...
class MyTrophiesAdapter(private val trophyList: List<Trophy>) :
    RecyclerView.Adapter<MyTrophiesAdapter.TrophyViewHolder>() {

    class TrophyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val trophyIcon: ImageView = itemView.findViewById(R.id.iv_trophy)
    }
